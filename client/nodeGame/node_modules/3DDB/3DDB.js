(function (exports, node) {
	...
	3DDB.prototype.count = function (key) {
		var count = 0;
	...
	3DDB.prototype.sum = function (key) {
		var sum = 0;
		for (var i=0; i < this.storage.length; i++) {
			try {
				var tmp = Utils.eval('this.' + key, this.storage[i]);
	...
	3DDB.prototype.mean = function (key) {
		var sum = 0;
		var count = 0;
		for (var i=0; i < this.storage.length; i++) {
			try {
	...
	3DDB.prototype.min = function (key) {
		var min = false;
		for (var i=0; i < this.storage.length; i++) {
			try {
				var tmp = Utils.eval('this.' + key, this.storage[i]);
	...
	3DDB.prototype.max = function (key) {
		var max = false;
		for (var i=0; i < this.storage.length; i++) {
			try {
				var tmp = Utils.eval('this.' + key, this.storage[i]);
	...
	3DDB.prototype.map = function (func) {
		var result = [];
		for (var i=0; i < this.storage.length; i++) {
	...
	3DDB.prototype.forEach = function (func) {
		for (var i=0; i < this.storage.length; i++) {
			func.call(this.storage[i]);
		}	
	};
	
	3DDB.prototype.add = function (player, key, value, state) {
	...
	3DDB.prototype.reverse = function () {
		return new 3DDB(this.game, this.options, this.storage.reverse());
	};
	 ...
	 * 
	 */
	3DDB.prototype.sort = function(func) {
		var func = func || GameBit.comparePlayer;
		return new 3DDB(this.game, this.options, this.storage.sort(func));
	};
	
	3DDB.prototype.sortByPlayer = function() {
		return this.storage.sort(GameBit.comparePlayer);
	}
	
	3DDB.prototype.sortByState = function() {
		return this.storage.sort(GameBit.compareState);
	}
	
	3DDB.prototype.sortByKey = function() {
		return this.storage.sort(GameBit.compareKey);
	}
	
	3DDB.prototype.sortByValue = function(key) {
	...
	3DDB.prototype.dump = function (reverse) {
		return this.storage;
	};	
	
	3DDB.prototype.toString = function () {
		var out = '';
		for (var i=0; i< this.storage.length; i++) {
			out += this.storage[i] + '\n'
		}	
	 ...
	 * 
	 */
	3DDB.prototype.get = function (gamebit) {
		...
		return new 3DDB(this.game, this.options, out);		
	};
	
	3DDB.prototype.getByPlayer = function (player) {
		return this.get(new GameBit({player:player}));
	};
	
	3DDB.prototype.getByState = function (state) {
		return this.get(new GameBit({state:state}));
	};
	
	3DDB.prototype.getByKey = function (key) {
	...
	3DDB.prototype.select = function (key, op, value) {
		if (!key) return this;
	...
	3DDB.prototype.filter = function (func) {
		return new 3DDB(this.game, this.options, this.storage.filter(func));
	};
	
	// Get Values

	3DDB.prototype.split = function () {
	...
	3DDB.prototype.groupBy = function (id) {
	...
	3DDB.prototype.join = function (key1, key2, newkey) {		
		return this._join(key1, key2, newkey, function(a,b) {return (a === b);});
	};
	
	3DDB.prototype.concat = function (key1, key2, newkey) {		
		return this._join(key1, key2, newkey, function(){ return true;});
	};

	3DDB.prototype._join = function (key1, key2, newkey, condition) {
	...
	3DDB.prototype.fetch = function (key,array) {
	...
	3DDB.prototype.fetchArray = function (key) {
		return this.fetch(key,true);
	};
	
	
	
	3DDB.prototype.fetchValues = function () {
		return this.fetch('VALUES');
	};
	
	3DDB.prototype.fetchKeyValues = function () {
		return this.fetch('KEY_VALUES');
	};
	
	3DDB.prototype.fetchValuesArray = function () {
		return this.fetchArray('VALUES');
	};
	
	3DDB.prototype.fetchKeyValuesArray = function () {
